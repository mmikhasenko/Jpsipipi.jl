...
md"""
## Dalitz plot for $X\to J/\psi \pi^+ \pi^-$

In thin notebook I code BESIII helicity amplitudes (eq.6 of [PRD2015](https://arxiv.org/pdf/2004.13788)) for the decay and compare to the DPD approach.

The reference values are provided by Nils Hüsken from the lab course of Mainz group.
"""

# ╔═╡ 5655d64f-c7b8-457a-beaa-d18817f770bf
md"""
## Set constants
"""
...
# ╔═╡ e424acbe-652e-4146-a704-550d7ddab2e0
const ms = ThreeBodyMasses(mJψ, mπ, mπ; m0 = sqrt_s);

# ╔═╡ 076958f3-6253-4872-8b34-9e30a2be5f23
...
Trying to replicate the model of ["Spin and Parity of Zc(3900)"](https://arxiv.org/pdf/1706.04100), and [Neutral Z analysis](https://arxiv.org/pdf/2004.13788)
"""
...
manifest_format = "2.0"
project_hash = "d8154e4727be7ce85ec933dd7b25669fdaf5b431"
